            ...
            if ($request->mode == "datatable") {
                return DataTables::of($produks)
                    ->addColumn('action', function ($produk) {
                        $detailButton = '<a href="produk/detail/'.$produk->id.'" class="btn btn-sm btn-info d-inline-flex  align-items-baseline  mr-1" ><i class="far fa-file mr-1"></i>Detail</a href="' . route('produk.show', $produk->id) . '">';
