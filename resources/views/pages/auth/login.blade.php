    ...
    <section class="section">
        <div class="d-flex align-items-stretch flex-wrap">
            <div class="d-none d-lg-block col-lg-8 py-5 min-vh-100 background-walk-y position-relative overlay-gradient-bottom order-1"
                data-background="{{ asset('images/icons/BJB.png') }}">
                <div class="absolute-bottom-left index-2">
                    <div class="text-light p-5 pb-2">
                        <div class="mb-5 pb-3">
                            <h5 class="font-weight-normal text-muted-transparent">BANK BJB KCP PEMKOT TASIKMALAYA</h5>
                            <h5 class="font-weight-normal text-muted-transparent">Jln. Rancabango
                        </div>
                    </div>
                </div>
            </div>
            <div
                ...
                <div class="py-2">
                    <div class="text-center mb-4">
                        <img src="{{ asset('images/icons/logoBJB.png') }}" width="100px" alt="logo">
                    </div>
                    ...
                    <small class='text-center mb-3 d-block '>Bank BJB KCP Pemkot Tasikmalaya</small>
                    ...
                    <div class="text-small mt-5 text-center">
                        Copyright &copy; {{ date('Y') }} <div class="bullet"></div> Create By Vidi Azzahra Mujahidillah
